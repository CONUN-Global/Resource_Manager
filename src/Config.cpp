...
{
    fprintf(stream, "Resource_Management, version %s\n", VERSION);
    fprintf(stream, "Resource_Management Copyright (C) 2012 Alexandre Quercia\n");
    ...
    fprintf(stream, "\n");
    fprintf(stream, "Usage: Resource_Management [OPTIONS...] TARGET\n");
    ...
    fprintf(stream, "       -c, --close     Close the specified Resource_Management attached to a TARGET (implies -z)\n");
